var salutations = {
		monday:{ 
		sarcastic: [", on this fiiiineass Monday, just remember:", ", yeah. I know you just REALLY love Mondays so... here.",", you’re such a scrooge. This one's for you. "],
		deep:[", you beautiful soul, don’t forget: ", ", if you’re feeling down, try remembering:", ", I just wanted to remind you this week:"],
		rude:[", yeeshc. Why you salty AF?!", ", your attitude needs a facelift pretty badly.", ", so what if it’s a @#$!ing Monday?!"],
	...
	fitness:{
		...
		rude:[", seriously! Get the schmuck off your ass!", ", it’s training time ya BIG SLOTH!", ", DROP THE DAMN BROWNIE AND PICK UP SOME WEIGHTS!"],
	...
	work:{
		sarcastic: [", did you think the bills were totally gonna pay themselves? This is for you:", ", it's time to see all of your AMAZING coworkers! Well either way... just keep in mind:", ", productive as ever. I thought you might need this:"],
		...
		rude:[", time to get up for work you maggot!", "!!! Rise and shine buttercup, it’s work time!", ", you’re late for work, wake the @#$! UP!!"],
	...
	school:{ 
		...
		rude:[", WAKE UP ALREADY, you have school!",", your attitude needs a major facelift.",", dayumn that face says it all..."],
...
var quotes = {
	monday:{ 
		...
		rude:["Do sharks complain about Monday? No. They’re up early, biting shit, chasing stuff, being scary — reminding everyone that they’re an effin' shark.", "You’ve gotten through 100% of the days in your past, today's not any different.", "Everything happens for a reason. Sometimes it’s because you were stupid. So just don’t be stupid next time okay?!"],
	...
	fitness:{
		...
		rude:["Need motivation to lose weight? Just eat in front of a mirror... NAKED. Seriously...", "If your pants could speak, they'd be saying \"I see you've been eating whatever you want and not exercising.\"", "Life's just not about avoiding the bruises. It’s about collecting the scars to prove you showed up for it."],
    ...
    school:{
        ...
        rude:["Seriously! If you think your teacher's tough, wait till you get a boss. HANDLE IT!", "Grades don’t define intelligence, but they’ll determine your escape from this hell!", "No matter how you feel, you're the one still responsible for how you act!"],
